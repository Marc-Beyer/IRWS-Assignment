...
// TODO: Error handling (e.g. wrong path), Let the user choose the queries to run, top 20 matches
let queries;
let nrOfQueries = 0;
...
function askForUserInput(readlineInterface) {
    readlineInterface.question(`\n${nrOfQueries} queries found. What do you want to do?\nExecute [a]ll queries, [id of query] or [q]uit -> `, (userInput) => {
        switch (userInput) {
            case "A":
            case "a":
